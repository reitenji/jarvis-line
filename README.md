...
```bash
python3 -m pip install "git+https://github.com/reitenji/jarvis-line.git@v0.2.2"
...
- `main`: release-ready code only. Public installs should prefer version tags such as `v0.2.2`.
